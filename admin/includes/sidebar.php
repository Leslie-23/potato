<div id="sidebar"><a href="#" class="visible-phone"><i class="fas fa-home"></i> Dashboard</a>
  <ul>
    ...
    <li class="submenu"> <a href="#"><i class="fas fa-users"></i> <span>Manage Members &raquo;</span> <span class="label label-important"><?php include 'dashboard-usercount.php';?> </span></a>
      <ul>
    ...
    <li class="submenu"> <a href="#"><i class="fas fa-dumbbell"></i> <span>Gym Equipment &raquo;</span> <span class="label label-important"><?php include 'dashboard-equipcount.php';?> </span></a>
    <ul>
    ...
    <li class="<?php if($page=='attendance'){ echo 'submenu active'; } else { echo 'submenu';}?>"> <a href="#"><i class="fas fa-calendar-alt"></i> <span>Attendance &raquo;</span></a>
      <ul>
    ...
    <li class="<?php if($page=='payment'){ echo 'active'; }?>"><a href="payment.php"><i class="fas fa-hand-holding-usd"></i> <span>Payments</span>  <span class="label label-important"><?php include 'transactions.php';?> </span></a></li>
    ...
    <li class="submenu"> <a href="#"><i class="fas fa-file"></i> <span>Reports &raquo;</span></a>
    <ul>
