  ...
  <ul class="nav right">
    <li  class="dropdown" id="profile-messages" ><a title="" href="#" data-toggle="dropdown" data-target="#profile-messages" class="dropdown-toggle"><i class="icon icon-user"></i>  <span class="text">Welcome Staff User</span><b class="caret"></b></a>
      <ul class="dropdown-menu">
        <li><a href="../staff-pages/profile.php" title="Profile"><i class="icon-user"></i> My Profile</a></li>
        <li class="divider"></li>
        <li><a href="../staff-pages/my-tasks.php" title="My Tasks"><i class="icon-check"></i> My Tasks</a></li>
        <li class="divider"></li>
        <li><a href="../logout.php" title="Logout"><i class="icon-key"></i> Log Out</a></li>
      </ul>
    </li>
