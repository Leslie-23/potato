...
<head>
    ...
    <body>
        ...
        <div id="loginbox">            
            ...
            <div class="control-group normal_text"> <h3><img src="img/icontest3.png" alt="Logo"  width="1024" height="559"/></h3></h3><h3>Manager Login</h3></div>
                ...
                <div class="form-actions center">
                    ...
                    <button type="submit" class="btn btn-block btn-large btn-success" title="Log In" name="login" value="Admin Login">Manager Login</button>
                </div>
            </form>
            <?php
