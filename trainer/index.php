...
<head>
    ...
    <body>
        ...
        <div id="loginbox">            
            ...
            <div class="control-group normal_text"> <h3><img src="img/icontest3.png" alt="Logo" /></h3></h3><h3>Trainer Login</h3></div>
                ...
                <div class="form-actions center">
                    ...
                    <button type="submit" class="btn btn-block btn-large btn-success" title="Log In" name="login" value="Admin Login">Trainer Login</button>
                </div>
            </form>
            <?php
